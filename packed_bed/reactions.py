...
REACTION_CATALOG = {
    "ni_reduction_h2_medrano": ReactionDefinition(
        ...
        kinetics_hook="medrano_ni_reduction_h2",
        reversible=False,
        notes="Medrano shrinking-core NiO reduction rate with Hamers pressure correction.",
    ),
    "ni_reduction_co_medrano": ReactionDefinition(
        ...
        source_reference="Medrano et al., Applied Energy 2015, https://doi.org/10.1016/j.apenergy.2015.08.078",
        kinetics_hook="medrano_ni_reduction_co",
        reversible=False,
        notes="Medrano shrinking-core NiO reduction rate with Hamers pressure correction.",
    ),
    "ni_oxidation_o2_medrano": ReactionDefinition(
        ...
        source_reference="Medrano et al., Applied Energy 2015, https://doi.org/10.1016/j.apenergy.2015.08.078",
        kinetics_hook="medrano_ni_oxidation_o2",
        reversible=False,
        notes="Medrano shrinking-core Ni oxidation rate with Hamers pressure correction.",
    ),
