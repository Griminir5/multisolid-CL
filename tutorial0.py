...
2b. Import or declare variable types
    ...
    The daeVariable constructor takes 7 arguments:
     - Name: string
     - Units: unit object
     ...
     - ValueConstraint: daeeVariableValueConstraint (the default is eNoConstraint)
         eNoConstraint - no constraint imposed on a variabe value (the default)
         eValueGTEQ - value constrainted to >= 0
         eValueLTEQ - value constrainted to <= 0
         eValueGT   - value constrainted to > 0
         eValueLT   - value constrainted to < 0
...
"""
time_type = daeVariableType("time_type", s, 0, 100,   0, 1e-5)
...
def consoleRun():
    ...
    """
    8.2 Calculate corrected initial conditions at time = 0.
